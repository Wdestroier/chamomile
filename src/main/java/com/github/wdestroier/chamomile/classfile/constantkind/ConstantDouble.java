...
@NoArgsConstructor
@AllArgsConstructor
public class ConstantDouble implements ConstantKind<ConstantDouble> {
	...
	@Override
	public ConstantDouble read(MultiEndianInputStream input, PseudoStructureFactory pseudoStructureFactory) {
