...
@NoArgsConstructor
@AllArgsConstructor
public class NullVariableInfo implements PseudoStructure<NullVariableInfo> {

	private short tag;

	@Override
	public NullVariableInfo read(MultiEndianInputStream input, PseudoStructureFactory pseudoStructureFactory) {
