...
@NoArgsConstructor
@AllArgsConstructor
public class RuntimeInvisibleTypeAnnotationsAttribute implements PseudoStructure<RuntimeInvisibleTypeAnnotationsAttribute> {
	...
	@Override
	public RuntimeInvisibleTypeAnnotationsAttribute read(MultiEndianInputStream input,
