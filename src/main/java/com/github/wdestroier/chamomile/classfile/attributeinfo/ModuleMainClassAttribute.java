...
@NoArgsConstructor
@AllArgsConstructor
public class ModuleMainClassAttribute implements PseudoStructure<ModuleMainClassAttribute> {
	...
	@Override
	public ModuleMainClassAttribute read(MultiEndianInputStream input, PseudoStructureFactory pseudoStructureFactory) {
	...
	public void write(MultiEndianOutputStream output) {
		...
		output.writeUnsignedShort(mainClassIndex);
	}
