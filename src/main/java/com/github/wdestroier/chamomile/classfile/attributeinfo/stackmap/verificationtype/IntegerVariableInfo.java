...
@NoArgsConstructor
@AllArgsConstructor
public class IntegerVariableInfo implements PseudoStructure<IntegerVariableInfo> {

	private short tag;

	@Override
	public IntegerVariableInfo read(MultiEndianInputStream input, PseudoStructureFactory pseudoStructureFactory) {
