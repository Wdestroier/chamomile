...
@NoArgsConstructor
@AllArgsConstructor
public class ConstantDynamic implements ConstantKind<ConstantDynamic> {
	...
	@Override
	public ConstantDynamic read(MultiEndianInputStream input, PseudoStructureFactory pseudoStructureFactory) {
