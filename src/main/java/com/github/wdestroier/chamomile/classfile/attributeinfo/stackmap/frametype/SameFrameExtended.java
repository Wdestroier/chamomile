...
@NoArgsConstructor
@AllArgsConstructor
public class SameFrameExtended implements PseudoStructure<SameFrameExtended> {

	private short frameType;
	private int offsetDelta;

	@Override
	public SameFrameExtended read(MultiEndianInputStream input, PseudoStructureFactory pseudoStructureFactory) {
