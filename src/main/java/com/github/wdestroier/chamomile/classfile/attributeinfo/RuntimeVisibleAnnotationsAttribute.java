...
@NoArgsConstructor
@AllArgsConstructor
public class RuntimeVisibleAnnotationsAttribute implements PseudoStructure<RuntimeVisibleAnnotationsAttribute> {
	...
	@Override
	public RuntimeVisibleAnnotationsAttribute read(MultiEndianInputStream input,
