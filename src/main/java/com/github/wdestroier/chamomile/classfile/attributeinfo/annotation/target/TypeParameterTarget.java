...
@NoArgsConstructor
@AllArgsConstructor
public class TypeParameterTarget implements PseudoStructure<TypeParameterTarget> {

	private short typeParameterIndex;

	@Override
	public TypeParameterTarget read(MultiEndianInputStream input, PseudoStructureFactory pseudoStructureFactory) {
