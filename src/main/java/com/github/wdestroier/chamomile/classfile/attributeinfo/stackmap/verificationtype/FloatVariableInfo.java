...
@NoArgsConstructor
@AllArgsConstructor
public class FloatVariableInfo implements PseudoStructure<FloatVariableInfo> {

	private short tag;

	@Override
	public FloatVariableInfo read(MultiEndianInputStream input, PseudoStructureFactory pseudoStructureFactory) {
