...
@NoArgsConstructor
@AllArgsConstructor
public class TopVariableInfo implements PseudoStructure<TopVariableInfo> {

	private short tag;

	@Override
	public TopVariableInfo read(MultiEndianInputStream input, PseudoStructureFactory pseudoStructureFactory) {
