...
@NoArgsConstructor
@AllArgsConstructor
public class RuntimeVisibleParameterAnnotationsAttribute implements PseudoStructure<RuntimeVisibleParameterAnnotationsAttribute> {
	...
	@Override
	public RuntimeVisibleParameterAnnotationsAttribute read(MultiEndianInputStream input,
