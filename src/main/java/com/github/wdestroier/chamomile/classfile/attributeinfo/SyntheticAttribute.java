...
@NoArgsConstructor
@AllArgsConstructor
public class SyntheticAttribute implements PseudoStructure<SyntheticAttribute> {

	private int attributeNameIndex;

	/**
	 * The value of the attribute length must be 0.
	 */
	private long attributeLength;

	@Override
	public SyntheticAttribute read(MultiEndianInputStream input, PseudoStructureFactory pseudoStructureFactory) {
