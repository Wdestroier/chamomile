...
@NoArgsConstructor
@AllArgsConstructor
public class SameFrame implements PseudoStructure<SameFrame> {

	private short frameType;

	@Override
	public SameFrame read(MultiEndianInputStream input, PseudoStructureFactory pseudoStructureFactory) {
