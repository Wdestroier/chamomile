...
@NoArgsConstructor
@AllArgsConstructor
public class DeprecatedAttribute implements PseudoStructure<DeprecatedAttribute> {

	private int attributeNameIndex;
	private long attributeLength;

	@Override
	public DeprecatedAttribute read(MultiEndianInputStream input, PseudoStructureFactory pseudoStructureFactory) {
