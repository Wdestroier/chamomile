...
@NoArgsConstructor
@AllArgsConstructor
public class UninitializedThisVariableInfo implements PseudoStructure<UninitializedThisVariableInfo> {

	private short tag;

	@Override
	public UninitializedThisVariableInfo read(MultiEndianInputStream input, PseudoStructureFactory pseudoStructureFactory) {
