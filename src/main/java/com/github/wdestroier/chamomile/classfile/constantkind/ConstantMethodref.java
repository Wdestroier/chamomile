...
@NoArgsConstructor
@AllArgsConstructor
public class ConstantMethodref implements ConstantKind<ConstantMethodref> {
	...
	@Override
	public ConstantMethodref read(MultiEndianInputStream input, PseudoStructureFactory pseudoStructureFactory) {
