...
@NoArgsConstructor
@AllArgsConstructor
public class NestHostAttribute implements PseudoStructure<NestHostAttribute> {
	...
	@Override
	public NestHostAttribute read(MultiEndianInputStream input, PseudoStructureFactory pseudoStructureFactory) {
	...
	public void write(MultiEndianOutputStream output) {
		...
		output.writeUnsignedShort(hostClassIndex);
	}
